                        ...
                        public void onSuccess(Location location) {
                            if (location != null) {
                                ...
                                try {
                                    ...
                                    address.setText("Salgy: " + addressList.get(0).getAddressLine(0));
                                    city.setText("Şäher : " +addressList.get(0).getLocality());
                                    country.setText("Ýurt: " +addressList.get(0).getCountryName());
